    ...
    <>
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <Link to="/" title="Resume" aria-label="Resume">
                        <img src={resume} alt="Resume logo" className="h-11 w-auto" />
                    </Link>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <p className="max-w-md text-center text-base my-7">Create,edit and download porfessional resumes with AI-powered assistance .</p>
