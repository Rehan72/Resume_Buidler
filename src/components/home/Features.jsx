...
function Features() {
  ...
  return (
        ...
        <div className="inline-flex items-center gap-2 text-sm text-green-800 bg-green-400/10 rounded-full px-4 py-1.5">
            <Zap width={16} height={16} className="text-green-800" />
            <span className="leading-none">Simple process</span>
        </div>
        <Title title='Build your resume' description='Our streamlined process helps you create a professional resume in minutes with intelligent AI-powered tools and features. No more hassle, just results.'/>
